...
1. 회사는 이용자의 개인정보를, 회원의 경우 탈퇴 시까지, 비회원의 경우 이용한 가게의 당일 영업 종료 시까지 보유 및 이용합니다.
2. 개인정보 보유 기간이 경과하거나, 처리 목적이 달성된 경우 해당 정보를 지체 없이 파기합니다.

제5조 (개인정보의 제3자 제공)
회사는 이용자의 개인정보를 원칙적으로 서비스 계약 업체를 제외한, 제3자에게 제공하지 않습니다. 다만, 다음의 경우에는 예외로 합니다.
1. 이용자가 사전에 동의한 경우
...
제10조 (개인정보 처리방침 변경)
회사는 개인정보 처리방침을 변경하는 경우에는 변경 및 시행 시기, 변경된 내용을 지속적으로 공개합니다. 이 방침은 2024년 5월 20일부터 시행됩니다.
''';
